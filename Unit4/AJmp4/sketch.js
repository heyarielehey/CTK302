...
function preload() {
  ...
  isucva50 = loadImage('assets/isucva50.png')
...
function setup() {
  ...
  places.push(new Place(40.50685995995287, -88.99067116816788, "CVA 50", .02, isucva50)); // new Place object, for ISU bridge over College Ave
